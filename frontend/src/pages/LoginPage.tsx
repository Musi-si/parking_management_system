...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if(res === 'user') navigate('/dashboard')
    } catch (err) {}
  }

  return (
    <div className="max-h-screen bg-gray-900 flex flex-col justify-center mt-20">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-400">Or{' '}
          <Link to="/register" className="font-medium text-gray-400 hover:text-primary-500">
            create a new account
          </Link>
        </p>
      </div>

      <div className="mt-8 mx-auto w-full max-w-md bg-dark-900">
        <Card>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Input id="password" name="password"
              type="password" label="Password" autoComplete="current-password" value={password}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-gray-400 hover:text-primary-500">
